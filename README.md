...
[![iOS Coverage](https://img.shields.io/codecov/c/github/gentle-giraffe-apps/GentleRemoteStrings?flag=ios&label=iOS%20coverage)](https://codecov.io/gh/gentle-giraffe-apps/GentleRemoteStrings?flags[0]=ios)
[![Backend Coverage](https://img.shields.io/codecov/c/github/gentle-giraffe-apps/GentleRemoteStrings?flag=backend&label=backend%20coverage)](https://codecov.io/gh/gentle-giraffe-apps/GentleRemoteStrings?flags[0]=backend)
